...
<head>
    ...
    <script src="https://sdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/js/all.min.js" crossorigin="anonymous"></script>
</head>
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="<? base_url('login/dologin') ?>" method="POST">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                            <a class="small" href="password.html">Forget Password?</a>
